#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# https://github.com/eyablokov/subnet-divider/blob/master/subnet-divider.py
# python subnet-divider.py 192.168.0.0/24 2
...
if __name__ == "__main__":
    # sys.argv[2] -> Get the require number of subnets to which the network will be divided
    divide_network(sys.argv[1], sys.argv[2])